...
namespace EmployeesCh12.Controllers
{
    public class DepartmentLocationController : Controller
    {
        ...
        {
            var employeeContext = _context.DepartmentLocation.Include(d => d.Department).Include(d => d.Location);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var departmentLocation = await _context.DepartmentLocation.FindAsync(id);
            if (departmentLocation == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.DepartmentLocation.Any(e => e.DepartmentID == id);
        }
    }
}
